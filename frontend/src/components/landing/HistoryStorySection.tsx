      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-y-8 lg:gap-y-12 items-center lg:gap-x-12">
          ...
          <div className="flex flex-col items-start text-left order-2 lg:order-1 pt-0 relative z-10">
            <h2 className="text-[32px] md:text-5xl lg:text-[56px] leading-[1.1] font-extrabold text-gray-900 mb-6 tracking-tight">
              Как мы начинали
            </h2>
            ...
            <div className="text-[15px] md:text-lg text-gray-600 leading-[1.6] mb-8 max-w-xl space-y-4">
              ...
              <p>
                Друзья попросили помочь и им. Потом их друзья. Потом совсем незнакомые люди с Авито. Так я постепенно создавал систему, которая стала BikeWerk.
              </p>
              <p>
