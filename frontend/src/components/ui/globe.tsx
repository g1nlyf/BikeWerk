...
export function Globe({
  ...
  const onResize = () => {
    if (canvasRef.current) {
      ...
      const spd = vw <= 360 ? 0.0015 : vw <= 480 ? 0.0016 : vw <= 768 ? 0.0018 : 0.002
  ...
  return (
    <div
      className={cn(
        // Более гибкий контейнер без абсолютного позиционирования или ограничений ширины
        "mx-auto aspect-[1/1] w-full",
        className,
      )}
    >
      <canvas
