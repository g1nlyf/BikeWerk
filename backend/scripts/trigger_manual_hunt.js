...
async function runRemoteCommand() {
    try {
        ...
        conn.on('ready', () => {
            console.log('✅ Connected. Executing manual hunt script...');
            // Command to run the script
            // We assume deploy.bat has run and updated the file
            const cmd = 'cd /root/eubike && node backend/scripts/manual_hunt_verbose.js';
