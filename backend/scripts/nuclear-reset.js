...
const UPLOADS_DIR_1 = path.resolve(__dirname, '../public/images/bikes'); // backend/public
const UPLOADS_DIR_2 = path.resolve(__dirname, '../../public/uploads/bikes'); // eubike/public
const BACKEND_UPLOADS = path.resolve(__dirname, '../uploads'); // backend/uploads
