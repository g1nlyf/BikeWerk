...
- **База данных:** **SQLite** (`backend/Databases/eubike.db`) хранит все данные, включая пользователей, велосипеды, заказы и логи.
- **Telegram-боты:**
...
- `Databases/`: Содержит файл базы данных SQLite.
